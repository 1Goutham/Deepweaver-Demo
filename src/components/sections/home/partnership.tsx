...
export default function Partnership() {
  return (
    <Section id="partnership" theme="light" pad="none" className="section-pad">
      <div className="mx-auto max-w-wide px-5 sm:px-8 lg:px-12">
        <div className="grid-12">
          ...
          <Reveal delay={0.08} className="col-span-12 mt-10 lg:col-span-7 lg:col-start-6 lg:mt-0">
        ...
        <Reveal delay={0.14} className="mt-20 lg:mt-28">
          <div className="grid gap-y-12 border-t border-line pt-10 md:grid-cols-2 md:gap-x-12">
            <div>
